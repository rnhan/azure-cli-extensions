...
@register_command(
    "container-storage pool volume show",
)
class Show(AAZCommand):
    """Get a Volume

    :example: Get a Volume.
        az container-storage pool volume show -g "rg" --pool-name "pool" -n "volume"
    """
    ...
    class VolumesGet(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            volume_type = cls._schema_on_200.properties.volume_type
            volume_type.elastic_san = AAZObjectType(
                serialized_name="elasticSan",
            )

            elastic_san = cls._schema_on_200.properties.volume_type.elastic_san
