...
@register_command(
    "container-storage pool volume list",
)
class List(AAZCommand):
    """List Volume resources by Pool

    :example: List Volumes.
        az container-storage pool volume list -g "rg" --pool-name "pool"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.VolumesListByPool(ctx=self.ctx)()
    ...
    class VolumesListByPool(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            volume_type = cls._schema_on_200.value.Element.properties.volume_type
            volume_type.elastic_san = AAZObjectType(
                serialized_name="elasticSan",
            )

            elastic_san = cls._schema_on_200.value.Element.properties.volume_type.elastic_san
