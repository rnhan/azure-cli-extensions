...
@register_command(
    "container-storage pool snapshot create",
)
class Create(AAZCommand):
    """Create a Snapshot

    :example: Create a Snapshot.
        az container-storage pool snapshot create -g "rg" --pool-name "pool" -n "snapshot" --source "volume"
    """
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.source = AAZStrArg(
            ...
            help="Reference to the source volume",
            fmt=AAZStrArgFormat(
                pattern="^[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]$",
                max_length=253,
                min_length=3,
    ...
    class SnapshotsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                properties.set_prop("source", AAZStrType, ".source", typ_kwargs={"flags": {"required": True}})
