...
@register_command(
    "container-storage pool snapshot update",
)
class Update(AAZCommand):
    """Update a Snapshot

    :example: Update a Snapshot.
        az container-storage pool snapshot update -g "rg" --pool-name "pool" -n "snapshot" --tags "{key2011:cccc}"
    """

    _aaz_info = {
        "version": "2023-07-01-preview",
        "resources": [
            ["mgmt-plane", "/subscriptions/{}/resourcegroups/{}/providers/microsoft.containerstorage/pools/{}/snapshots/{}", "2023-07-01-preview"],
        ]
    }
    ...
    class SnapshotsCreateOrUpdate(AAZHttpOperation):
        ...
        def _build_schema_on_200_201(cls):
            ...
            _UpdateHelper._build_schema_snapshot_read(cls._schema_on_200_201)
...
class _UpdateHelper:
    ...
    def _build_schema_snapshot_read(cls, _schema):
        ...
        status = _schema_snapshot_read.properties.status
