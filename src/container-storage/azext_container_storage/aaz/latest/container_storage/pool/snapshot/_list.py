...
@register_command(
    "container-storage pool snapshot list",
)
class List(AAZCommand):
    """List Snapshot resources by Pool

    :example: List Volumes in a Snapshot.
        az container-storage pool snapshot list -g "rg" --pool-name "pool"
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.SnapshotsListByPool(ctx=self.ctx)()
    ...
    class SnapshotsListByPool(AAZHttpOperation):
